# `DACE_jll.jl` (v0.7.1+0)

[![deps](https://juliahub.com/docs/DACE_jll/deps.svg)](https://juliahub.com/ui/Packages/General/DACE_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/ae48a25e4bfc0ff46c800726778bed38f28b3b46/D/DACE/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/a-ev/dace.git (revision: `bc26842ae5c6936f9e008a2dc0d9227a8d982acc`)
